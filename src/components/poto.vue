<template>
  <div class="photo-widget">
    ...
    <button @click="getRandomPhoto" class="search-button">Ganti</button>
  </div>
</template>
  ...
  methods: {
    async getRandomPhoto() {
      try {
        ...
        const apiUrl = `https://pixabay.com/api/?key=${apiKey}&q=cat&image_type=photo&orientation=horizontal`;
